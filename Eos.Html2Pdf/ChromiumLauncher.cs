...
namespace PuppeteerSharp
{
    ...
    public class ChromiumLauncher : LauncherBase
    {
        ...
        {
            PrepareChromiumArgs(options, out List<string> chromiumArgs, out TempDirectory TempUserDataDir);
        ...
        private static void PrepareChromiumArgs(LaunchOptions options, out List<string> chromiumArgs, out TempDirectory tempUserDataDirectory)
        {

            chromiumArgs = new List<string>();
